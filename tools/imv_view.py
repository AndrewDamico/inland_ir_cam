...
from inland_ir_cam.msg import MotionVectors
...
def img_callback(msg):
	try:
		...
		cv2.imshow('inland_ir_cam motion vectors visualization', img)
		cv2.waitKey(25)
...
def main():
	...
	img_topic = '/inland_ir_cam/image/compressed'
	imv_topic = '/inland_ir_cam/motion_vectors'
